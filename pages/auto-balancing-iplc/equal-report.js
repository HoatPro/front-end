        ...
        return (<Table celled structured id="tblList">
            <Table.Header>
                <Table.Row>
                    ...
                    <Table.HeaderCell>Equal-Rate(G)</Table.HeaderCell>
                    <Table.HeaderCell>Equal-Speed (G)</Table.HeaderCell>
                    <Table.HeaderCell>Equal-Congest</Table.HeaderCell>
                    <Table.HeaderCell>Equal-Free</Table.HeaderCell>
                    <Table.HeaderCell>Equal-Device</Table.HeaderCell>
                </Table.Row>
            </Table.Header>
            <Table.Body>
                {
...
class EqualReport extends Component {
    constructor(props) {
        super(props);
        this.state = {
            search: {searchByName: ''},
    ...
    componentDidMount() {
        ...
        if (_.size(this.state.equalReportData)===0) {
            this.props.dispatch(autoBalancingIPLC.getEqualReportData());
        }
    }

    componentWillReceiveProps(nextProps) {
        const {equalReportData} = nextProps;
        let listData = equalReportData;
        console.log("a");
...
export default connect(mapStateToProps, null)(EqualReport);