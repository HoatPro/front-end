...
class IplcMpopByGwIpv4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            search: {searchByName: ''},
    ...
    componentDidMount() {
        ...
        if (_.size(this.state.iplcMpopByGwDataIpv4)===0) {
            this.props.dispatch(autoBalancingIPLC.getIplcMpopByGwDataIpv4());
        }
    }

    componentWillReceiveProps(nextProps) {
        const {iplcMpopByGwDataIpv4} = nextProps;
        let listData = iplcMpopByGwDataIpv4;
        this.setState({
            iplcMpopByGwDataIpv4:iplcMpopByGwDataIpv4,
            listData: listData,
...
export default connect(mapStateToProps, null)(IplcMpopByGwIpv4);