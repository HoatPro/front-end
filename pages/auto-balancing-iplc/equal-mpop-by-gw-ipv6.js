...
class EqualMpopByGwIpv6 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            search: {searchByName: ''},
    ...
    componentDidMount() {
        ...
        if (_.size(this.state.equalMpopByGwDataIpv6)===0) {
            this.props.dispatch(autoBalancingIPLC.getEqualMpopByGwDataIpv6());
        }
    }

    componentWillReceiveProps(nextProps) {
        const {equalMpopByGwDataIpv6} = nextProps;
        let listData = equalMpopByGwDataIpv6;
        this.setState({
            equalMpopByGwDataIpv6: equalMpopByGwDataIpv6,
            listData: listData,
...
export default connect(mapStateToProps, null)(EqualMpopByGwIpv6);